...
~ Clean welcome layout
~ Quick navigation to main sections

2- Recipes
~ Recipes displayed dynamically from data files
...
Cooking mode with step navigation
Optional video tutorial links

3- Ingredients & Ordering
~ Interactive ingredient lists
~ Ability to select specific ingredients
~ Generate shopping lists from recipes
~ Orders grouped and organized clearly

4- Pantry
~ Add ingredients already available at home
~ Smart recipe suggestions based on pantry items

--> Separate sections for:
Fully available recipes
Almost available recipes (missing few ingredients)
...
~ Favorites linked to the user session
...
Recipes Page – Browse and filter recipes

Recipe Details – Ingredients and instructions

Meal Planner – Weekly planning interface

Orders / Shopping List – Generated ingredient list
